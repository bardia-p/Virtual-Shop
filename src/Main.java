...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Was the transaction successful? "+ store1.transaction(orders1));

        int[][] orders2 ={{p1.getId(),6},{p2.getId(),1},{p3.getId(),2}};
        System.out.println("Was the transaction successful? "+ store1.transaction(orders2));

        int[][] orders3 ={{p4.getId(),15}};
        System.out.println("Was the transaction successful? "+ store1.transaction(orders3));

        store1.inv.addStock(p4,30);
        store1.inv.addStock(p1,10);

        int[][] orders4 ={{p4.getId(),15},{p1.getId(),5}};
        System.out.println("Was the transaction successful? "+ store1.transaction(orders4));
    }
}